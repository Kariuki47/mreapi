...
const Realm = require('../common/models/realm');
const Lease = require('../common/models/lease');
...
// const NewTenant = require('../common/models/newtenant');
// const Document = require('../common/models/document');
// const Contract = require('../common/models/contract');
